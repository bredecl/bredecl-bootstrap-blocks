...
const defaultClassName = getBlockDefaultClassName("bredecl-bootstrap-blocks/button-group");
...
export const modifyBlockListBlockButtonGroup = createHigherOrderComponent( ( BlockListBlock ) => {
  return ( props ) => {
    if (props.block.name == "bredecl-bootstrap-blocks/button-group") {
...
export const modifyGetSaveElementButtonGroup = (element, blockType, attributes) => {
  ...
  if (blockType.name == 'bredecl-bootstrap-blocks/button-group') {
    return (
      <div 
