...
export const edit = (props) => {
  ...
  return (
    <Fragment>
      ...
      <InspectorControls>
          <PanelBody
              title={ __( 'Button Settings', 'bredecl-bootstrap-blocks' ) }
          >
            <PanelRow>
              <BaseControl
                className="w-100"
            ...
            <PanelRow>
                ...
                >
                    { __( 'Button Outline Setting', 'bredecl-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-outline"
                    label={ __( 'Toggle Outline', 'bredecl-bootstrap-blocks' ) }
                    checked={outline}
            ...
            <PanelRow>
                ...
                >
                    { __( 'Button Block Setting', 'bredecl-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-block"
                    label={ __( 'Toggle block', 'bredecl-bootstrap-blocks' ) }
                    checked={block}
            ...
            <PanelRow>
                ...
                >
                    { __( 'Open link in new window', 'bredecl-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-window"
                    label={ __( 'Open link in new window', 'bredecl-bootstrap-blocks' ) }
                    checked={newWindow}
