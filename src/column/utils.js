...
const defaultClassName = getBlockDefaultClassName("bredecl-bootstrap-blocks/column");
...
export const modifyBlockListBlockColumn = createHigherOrderComponent( ( BlockListBlock ) => {
  return ( props ) => {
    if (props.block.name == "bredecl-bootstrap-blocks/column") {
...
export const modifyGetSaveElementColumn = (element, blockType, attributes ) => {
  ...
  if (blockType.name == 'bredecl-bootstrap-blocks/column') {
    return (
      <div 
