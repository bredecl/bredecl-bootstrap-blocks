...
export const edit = (props) => {
  ...
  return (
    <Fragment>
      ...
      <InspectorControls>
          <PanelBody
              title={ __( 'Container Settings', 'bredecl-bootstrap-blocks' ) }
              initialOpen={true}
          >
            <PanelRow>
                <label
                ...
                >
                    { __( 'Full-width Container', 'bredecl-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-fluid"
                    label={ __( 'Full-width container', 'bredecl-bootstrap-blocks' ) }
                    checked={ isFluid }
            ...
            <PanelRow>
                <label
                    htmlFor="form-toggle-fluid"
                >
                    { __( 'Wrap container', 'bredecl-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-fluid"
                    label={ __( 'Add Wrapper', 'bredecl-bootstrap-blocks' ) }
                    checked={ isWrapped }
          ...
          <PanelBody
            title={ __( 'Background Image Settings', 'bredecl-bootstrap-blocks' ) }
            initialOpen={false}
          >
            <PanelRow>
              <div className="w-100">
                ...
                >
                    { __( 'Background Image', 'bredecl-bootstrap-blocks' ) }
                </label>
                <MediaUpload 
              ...
              <Fragment>
                <PanelRow className="my-0">
                  <BaseControl
                    ...
                    >
                        { __( 'Background Position X', 'bredecl-bootstrap-blocks' ) }
                    </label>
                    <input 
                ...
                <PanelRow className="my-0">
                  ...
                  >
                    ...
                    >
                        { __( 'Background Position Y', 'bredecl-bootstrap-blocks' ) }
                    </label>
                    <input 
