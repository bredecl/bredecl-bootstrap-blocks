...
Are you using Advanced Bootstrap Blocks? [Write a review](https://wordpress.org/plugins/bredecl-bootstrap-blocks/#reviews)!
...
The example below may get you started. Visit the [WordpPress Block Editor Handbook](https://developer.wordpress.org/block-editor/developers/block-api/block-templates/) to learn more about supercharging your WordPress themes with blocks templates. 
	...
	<?php
	if(in_array('bredecl-bootstrap-blocks/bredecl-bootstrap-blocks.php', apply_filters('active_plugins', get_option('active_plugins')))){ 
...
Yes. Please submit issues, bugs, and feature requests through the [plugin support page](https://wordpress.org/support/plugin/bredecl-bootstrap-blocks/) or browse the source and contribute at [GitHub](https://github.com/bredecl-bootstrap-blocks/bredecl-bootstrap-blocks) or [GitLab](https://gitlab.com/helpful.dev/bredecl-bootstrap-blocks) (mirror). 
